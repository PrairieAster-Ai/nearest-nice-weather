-- ========================================================================
-- CORRECTED PRODUCTION POI MIGRATION - PART 1 OF 5 
-- ========================================================================
-- Insert first 30 POI locations with new schema structure
-- Uses clean Preview environment data (138 total POI)
-- ========================================================================
...
-- Verify batch 1 count (should be 30)
